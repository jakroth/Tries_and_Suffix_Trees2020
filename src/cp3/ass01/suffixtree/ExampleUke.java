...
/**
 * TRENT: this is not my code. This was written by Daniel Mariselli on GitHub.
 * https://github.com/dmariselli/Ukkonen-Suffix-Tree
 * I used it to benchmark and compare with my implementation.
 */

public class ExampleUke {
    ...
    private void processIndex(int index) {
        ...
        // Trick Three: Update end value of all leaf edges by updating the global end variable.
